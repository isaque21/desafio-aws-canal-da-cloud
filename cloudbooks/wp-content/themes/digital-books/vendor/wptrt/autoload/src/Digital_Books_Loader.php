...
class Digital_Books_Loader {
	 ...
	 * @return void
	 */
	public function digital_books_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function digital_books_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function digital_books_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function digital_books_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->digital_books_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function digital_books_load( $class ) {
